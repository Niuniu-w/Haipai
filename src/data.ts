...
export const demoScenes: Scene[] = [
  {
    ...
    characters: ['林墨', '周岚'],
    actions: ['林墨收起滴水的黑伞，推开即将打烊的咖啡馆。', '周岚没有迎上来，只朝最里面那张桌子看了一眼。', '林墨拿起没有署名的信，门外的黑伞在雨幕中停顿。'],
    dialogues: [
      { id: 'd-1', character: '林墨', emotion: '疑惑', line: '这是留给我的？' },
      { id: 'd-2', character: '周岚', emotion: '克制', line: '我只负责让你看到它。' },
      { id: 'd-3', character: '林墨', emotion: '警觉', line: '十二年前，到底发生了什么？' },
    ],
  ...
  },
  {
    ...
    characters: ['林墨', '苏禾'],
    actions: ['苏禾用手电扫过一排排落灰的卷宗。', '林墨发现父亲当年的事故档案中少了一袋底片。', '电脑屏幕上，借阅记录最后一行闪烁着被覆盖过的痕迹。'],
    dialogues: [
      { id: 'd-4', character: '苏禾', emotion: '笃定', line: '记录可以改，但时间戳不会说谎。' },
      { id: 'd-5', character: '林墨', emotion: '低声', line: '有人比我们更怕找到这些底片。' },
    ],
  ...
  },
  {
    ...
    actions: ['陈望迎着江风展开底片，工程车的轮廓在灯下显现。', '周岚从桥墩后走出，第一次说出姐姐的名字。', '远处车灯突然亮起，急刹声划破江面。'],
    dialogues: [
      { id: 'd-6', character: '陈望', emotion: '沉重', line: '你父亲不是不敢写，他是在等证据。' },
      { id: 'd-7', character: '周岚', emotion: '坚定', line: '我等了十二年，不想再等下一个十二年。' },
    ],
  ...
  },
  {
    ...
    actions: ['扫描仪吐出最后一张底片，上传进度停在百分之九十九。', '电话响起，林墨看着屏幕上的陌生号码按下录音键。', '清晨六点，发布按钮由灰色变为红色。'],
    dialogues: [
      { id: 'd-8', character: '高启明', emotion: '冷静', line: '你父亲的名字，也会和这篇报道一起被毁掉。' },
      { id: 'd-9', character: '林墨', emotion: '坚定', line: '有些故事迟到了，但不会消失。' },
    ],
